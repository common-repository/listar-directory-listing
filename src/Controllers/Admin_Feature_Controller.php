...
class Admin_Feature_Controller {

    public function __construct() {
        add_action( 'created_listar_feature', [$this, 'save']);
        add_action( 'edited_listar_feature', [$this, 'save']);

        add_action( 'listar_feature_add_form_fields', [$this, 'form']);
        add_action( 'listar_feature_edit_form_fields', [$this, 'form']);
        ...
        add_filter( 'manage_edit-listar_feature_columns', [$this, 'admin_columns_filter'] );
        // manage_{TAXONOMY}_custom_column
        add_action( 'manage_listar_feature_custom_column', [$this, 'admin_columns_action'], 10, 3);
    }
    ...
    public function form($term) {
        ...
        if(is_object($term) && $term->term_id) {
            include_once $listar->plugin_path() . '/views/metadata/feature-edit.php';
        } else {
            include_once $listar->plugin_path() . '/views/metadata/feature.php';
        }
    }
    ...
    public function save($term_id) {
        ...
        Feature_Model::set_metadata(absint($term_id), $_POST);
    }
