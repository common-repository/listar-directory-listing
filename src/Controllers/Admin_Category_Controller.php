...
class Admin_Category_Controller {

    public function __construct() {
        add_action( 'created_listar_category', [$this, 'save']);
        add_action( 'edited_listar_category', [$this, 'save']);

        add_action( 'listar_category_add_form_fields', [$this, 'form']);
        add_action( 'listar_category_edit_form_fields', [$this, 'form']);
        ...
        add_filter( 'manage_edit-listar_category_columns', [$this, 'admin_columns_filter'] );
        // manage_{TAXONOMY}_custom_column
        add_action( 'manage_listar_category_custom_column', [$this, 'admin_columns_action'], 10, 3);
    }
    ...
    public function form($term) {
        ...
        if(is_object($term) && $term->term_id) {
            include_once $listar->plugin_path() . '/views/metadata/category-edit.php';
        } else {
            include_once $listar->plugin_path() . '/views/metadata/category.php';
        }
    }
    ...
    public function save($post_id) {
        ...
        Category_Model::set_metadata(absint($post_id), $_POST);
    }
