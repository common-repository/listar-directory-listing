<!-- Color -->
<tr class="form-field term-group term-colorpicker-wrap">
    <th scope="row"><label for="color"><?php _e('Color', 'listar');?></label></th>
    <td>
        <input name="color" value="<?php echo $term->color; ?>" class="color-field" id="color" />
    </td>
</tr>
<!-- Icon -->
<tr class="form-field term-group">
    ...
    <button class="button"><i class="<?php echo $term->icon ? esc_attr($term->icon) : 'fas fa-star'; ?>"></i></button>
        <input data-placement="right" class="icp iconpicker button button-secondary"  name="icon" value="<?php echo $term->icon ? esc_attr($term->icon) : 'fa-archive'; ?>">  
    </td>
</tr>
<!-- Image -->
<tr class="form-field term-group-wrap">
    ...
    <td>
        <input type="hidden" id="featured-image" class="listar-featured-image" name="featured_image" value="<?php echo esc_attr( $term->featured_image ); ?>">
