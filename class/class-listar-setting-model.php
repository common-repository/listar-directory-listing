                ...
                'sections' => [
                    'common' => [
                        ...
                        'options' => [
                            ...
                            [
                                'name' => __('Editor', 'listar'),
                                'desc' => __('Use it to create media-rich pages and posts and to control their layout with ease', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'editor',
                                'type' => 'checkbox'
                            ],
                            [
                                'name' => __('Default Icon', 'listar'),
                                'desc' => __('The default icon will be use for meta data field', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'icon',
                                'type' => 'text',
                                'default' => 'fa fa-star',
                            ],
                            [
                                'name' => __('Default Featured Image', 'listar'),
                            ...
                            [
                                'name' => __('Post Per Page', 'listar'),
                                'desc' => __('Total number post per page will be displayed', 'listar'),
                            ...
                            [
                                ...
                                'desc' => __('Then color default use for icon', 'listar'),
                            ...
                            [
                                ...
                                'desc' => __('List color is separated by comma', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'color_option',
                                'type' => 'text',
                                'default' => '#E5634D, #5DADE2, #A569BD, #58D68D, #FDC60A, #3C5A99, #5D6D7E',
                            ],
//                            [
//                                'name' => __('Color', 'listar'),
//                                'desc' => __('Select your color style', 'listar'),
//                                'id'   =>  Listar::$option_prefix. 'skin',
//                                'type' => 'select',
//                                'default' => 'orange-skin',
//                                'options' => [
//                                    'orange-skin' => __('Orange', 'listar'),
//                                    'lightblue-skin' => __('Light Blue', 'listar'),
//                                    'pink-skin' => __('Pink', 'listar'),
//                                    'green-skin' => __('Green', 'listar'),
//                                    'yellow-skin' => __('Yellow', 'listar'),
//                                    'blue-skin' => __('Blue', 'listar'),
//                                ]
//                            ],
//                            [
//                                'name' => __('Dark Mode', 'listar'),
//                                'desc' => __('Adjust your appearance', 'listar'),
//                                'id'   =>  Listar::$option_prefix. 'dark_mode',
//                                'type' => 'select',
//                                'default' => 'light',
//                                'options' => [
//                                    'dark' => __('Dark', 'listar'),
//                                    'light' => __('Light', 'listar'),
//                                ]
//                            ],
                            [
                                'name' => __('List Mode', 'listar'),
                                'desc' => __('Listing Mode', 'listar'),
...
//                            [
//                                'name' => __('Skin control', 'listar'),
//                                'desc' => __('Show the skin toolbar in the front page', 'listar'),
//                                'id'   =>  Listar::$option_prefix. 'skin_control',
//                                'type' => 'checkbox',
//                            ]
                        ]
                    ],
                    'contact' => [
                        'title' => __('Contact', 'listar'),
                        'options' => [
                            [
                    ...
                    'map' => [
                        'title' => __('Map Settings', 'listar'),
                        'options' => [
                            [
                                'name' => __('Use Map', 'listar'),
                                'desc' => __('It uses Google Maps platform and requires an API key', 'listar'),
                            ...
                            [
                                'name' => __('Zoom', 'listar'),
                                'desc' => __('Google Map zoom levels', 'listar'),
                    ...
                    'mobile' => [
                        'title' => __('Mobile Settings', 'listar'),
                        'options' => [
                            [
                                'name' => __('Single Device Use', 'listar'),
                                'desc' => __('The account get push notification with last device login. If option is unchecked, the account can receive notification with many devices', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'push_single_device',
                                'type' => 'checkbox',
                            ],
                            [
                                'name' => __('Header Image Slider', 'listar'),
                                'desc' => __('Image slider at mobile home screen. The aspect ratio of an image displayed should be 2:3. Example: Image size 375px:250px', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'mobile_slider',
                                'type' => 'gallery',
                                'default' => ''
                            ],
                            [
                                'name' => __('Allow Submit Listing', 'listar'),
                                'desc' => __('User can submit listing directory via the mobile app', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'submit_listing_use',
                                'type' => 'checkbox',
                                'default' => true,
                            ],
                            [
                                'name' => __('Verify Submit Listing', 'listar'),
                                'desc' => __('The administrator verify from user before the listing directory is published. The default status is Pending', 'listar'),
                ...
                'sections' => [
                    ...
                    'paypal' => [
                        ...
                        'options' => [
                            [
                                'name' => __('Enable/Disable', 'listar'),
                                'desc' => __('Enable PayPal Checkout v2', 'listar'),
                    ...
                    'stripe' => [
                        ...
                        'options' => [
                            [
                                'name' => __('Enable/Disable', 'listar'),
                                'desc' => __('Enable Stripe Payment (Credit Card)', 'listar'),
                    ...
                    'cash' => [
                        ...
                        'options' => [
                            [
                                'name' => __('Enable/Disable', 'listar'),
                                'desc' => __('Enable cash on delivery', 'listar'),
                    ...
                    'bank' => [
                        ...
                        'options' => [
                            [
                                'name' => __('Enable/Disable', 'listar'),
                                'desc' => __('Enable bank transfer', 'listar'),
                ...
                'sections' => [
                    'general' => [
                        ...
                        'options' => [
                            ...
                            [
                                ...
                                'desc' => __('Enter recipients (comma separated) for this email', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_recipient',
                                'type' => 'text',
                                'default' => 'service@passionui.com'
                            ],
                            [
                                'name' => __('Mobile Push', 'listar'),
                                'desc' => __('Send push notification to user\'s mobile device', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'mobile_push_use',
                                'type' => 'checkbox',
                                'default' => false,
                            ],
                            [
                                'name' => __('Firebase Settings', 'listar'),
                                'desc' => __('Firebase Cloud Messaging server key for mobile push.', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'fcm_key',
                                'type' => 'text',
                            ],
                            [
                                'name' => __('Firebase Debug', 'listar'),
                                'desc' => __('Enable debug mode', 'listar'),
                            ...
                            [
                                ...
                                'desc' => __('The token will get notification. Enter the mobile push token key, separate by the comma. Ex: abc,xyz', 'listar'),
                    ...
                    'order' => [
                        ...
                        'options' => [
                            ...
                            [
                                'name' => __('Mobile Push', 'listar'),
                                'desc' => __('Send push notification to owner', 'listar'),
                    ...
                    'cancel' => [
                        ...
                        'options' => [
                            ...
                            [
                                'name' => __('Mobile Push', 'listar'),
                                'desc' => __('Send push notification to owner & user', 'listar'),
                    ...
                    'status' => [
                        'title' => __('Change Status', 'listar'),
                        'options' => [
                            [
                                'name' => __('Email', 'listar'),
                                'desc' => __('Send email notification when admin change the booking status', 'listar'),
                            ...
                            [
                                'name' => __('Email Recipient(s)', 'listar'),
                                'desc' => __('Enter recipients (comma separated) for this email. The default is receiver who requested booking', 'listar'),
                            ...
                            [
                                'name' => __('Mobile Push', 'listar'),
                                'desc' => __('Send push notification when admin change booking status', 'listar'),
                    ...
                    'publish_new' => [
                        'title' => __('Publish Listing', 'listar'),
                        'options' => [
                            [
                                'name' => __('Enable/Disable', 'listar'),
                                'desc' => __('Send a mobile push notification to all users when the new directory listing is published', 'listar'),
                    ...
                    'update_exist' => [
                        'title' => __('Update Listing', 'listar'),
                        'options' => [
                            [
                                'name' => __('Enable/Disable', 'listar'),
                                'desc' => __('Send a mobile push notification to all users when the new directory listing is updated', 'listar'),
                    ...
                    'submit_listing' => [
                        'title' => __('Submit Listing', 'listar'),
                        'options' => [
                            [
                                'name' => __('Email', 'listar'),
                                'desc' => __('Send email notification to administrators when the new listing is submitted', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_submit_listing_use',
                                'type' => 'checkbox',
                                'default' => true,
                            ],
                            [
                                'name' => __('Email Recipient(s)', 'listar'),
                                'desc' => __('Enter recipients (comma separated) for this email', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_submit_listing_recipient',
                                'type' => 'text',
                                'default' => ''
                            ],
                            [
                                ...
                                'id'   =>  Listar::$option_prefix. 'email_submit_listing_subject',
                                'type' => 'text',
                            ...
                            [
                                ...
                                'id'   =>  Listar::$option_prefix. 'email_submit_listing_content',
                                'type' => 'wysiwyg',
                            ...
                            [
                                'name' => __('Email Type', 'listar'),
                                'desc' => __('Choose which format of email to send.', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_submit_listing_type',
                                'type' => 'select',
                                'default' => 'html',
                                'options' => [
                                    'html' => __('HTML', 'listar'),
                            ...
                            [
                                'name' => __('Mobile Push', 'listar'),
                                'desc' => __('Send push notification to administrators when the new listing is submitted', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'push_submit_listing_use',
                                'type' => 'checkbox',
                                'default' => true,
                            ],
                            [
                                'name' => __('Mobile Push Content', 'listar'),
                                'desc' => __('Input content with plain text format', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'push_submit_listing_content',
                                'type' => 'textarea',
                                'default' => 'The new listing is submitted: {post_title}.'
                            ],
                        ],
                    ...
                    'approve_listing' => [
                        'title' => __('Approve Listing', 'listar'),
                        'options' => [
                            [
                                'name' => __('Email', 'listar'),
                                'desc' => __('Send email notification to user when the listing has approved and published', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_approve_listing_use',
                                'type' => 'checkbox',
                                'default' => true,
                            ],
                            [
                                'name' => __('Subject', 'listar'),
                                'desc' => __('Available placeholders: {site_title}, {site_url}, {created_on}, {post_title}', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_approve_listing_subject',
                                'type' => 'text',
                            ...
                            [
                                'name' => __('Content', 'listar'),
                                'desc' => __('Text to appear below the main email content. Available placeholders: {site_title}, {site_url}, {created_on}, {post_title}', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_approve_listing_content',
                                'type' => 'wysiwyg',
                            ...
                            [
                                'name' => __('Email Type', 'listar'),
                                'desc' => __('Choose which format of email to send.', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'email_approve_listing_type',
                                'type' => 'select',
                                'default' => 'html',
                                'options' => [
                                    'html' => __('HTML', 'listar'),
                            ...
                            [
                                'name' => __('Mobile Push', 'listar'),
                                'desc' => __('Send push notification to user when the listing has approved and published', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'push_approve_listing_use',
                                'type' => 'checkbox',
                                'default' => true,
                            ],
                            [
                                'name' => __('Mobile Push Content', 'listar'),
                                'desc' => __('Input content with plain text format', 'listar'),
                                'id'   =>  Listar::$option_prefix. 'push_approve_listing_content',
                                'type' => 'textarea',
                                'default' => 'The administrator has approved your listing: {post_title}.'
                            ],
                        ],
    ...
    static function default_image()
    {
        ...
        if(is_null(self::$default_image)) {
            ...
            if ($image_value > 0) { // has set value as int
                $image_large = wp_get_attachment_image_src($image_value, 'full');
